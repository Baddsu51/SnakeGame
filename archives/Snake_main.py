...
# Chargement du son
path_hit_noice = './assets/punch_whistle_noice.wav'
#path_eating_noice = 'apple_eating_noice.wav'
path_eating_noice = './assets/apple_munch_noice.wav'
...
apple_path = "./assets/temp_apple.gif"  # Chemin du fichier temporaire
...
image_path = "./assets/carre_arrondi.png"
image = Image.open(image_path)
...
# Enregistrer l'image temporaire
carre_path = "./assets/temp_carre.gif"  # Chemin du fichier temporaire
...
def save_highscore():
    ...
    with open("./assets/score.txt", "w") as fichier:
        # Écrire la variable dans le fichier
        fichier.write(str(highscore))

# Charger l'image
image_path = "./assets/head_snake.png"
image = Image.open(image_path)
...
head_snake_nord = "./assets/temp_head_snake_nord.gif"  # Chemin du fichier temporaire
image.save(head_snake_nord)

image_sud = image.rotate(180)
head_snake_sud = "./assets/temp_head_snake_sud.gif"  # Chemin du fichier temporaire
image_sud.save(head_snake_sud)

image_est = image.rotate(270)
head_snake_est = "./assets/temp_head_snake_est.gif"  # Chemin du fichier temporaire
image_est.save(head_snake_est)

image_ouest = image.rotate(90)
head_snake_ouest = "./assets/temp_head_snake_ouest.gif"  # Chemin du fichier temporaire
...
# Ouvrir le fichier en mode écriture
with open('./assets/score.txt', "r") as fichier:
