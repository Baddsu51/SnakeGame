...
# Chargement du son
path_hit_noice = join("assets", "punch_whistle_noice.wav")
#path_eating_noice = 'apple_eating_noice.wav'
path_eating_noice = join("assets",'apple_munch_noice.wav')
...
image_path = join("assets","apple.png")
...
apple_path = join("assets","temp_apple.gif")  # Chemin du fichier temporaire
...
image_path = join("assets","carre_arrondi.png")
image = Image.open(image_path)
...
# Enregistrer l'image temporaire
carre_path = join("assets","temp_carre.gif")  # Chemin du fichier temporaire
...
def save_highscore():
    ...
    with open(join("assets","score.txt"), "w") as fichier:
        # Écrire la variable dans le fichier
        fichier.write(str(highscore))

# Charger l'image
image_path = join("assets","head_snake.png")
image = Image.open(image_path)
...
head_snake_nord = join("assets","temp_head_snake_nord.gif")  # Chemin du fichier temporaire
image.save(head_snake_nord)

image_sud = image.rotate(180)
head_snake_sud = join("assets","temp_head_snake_sud.gif")  # Chemin du fichier temporaire
image_sud.save(head_snake_sud)

image_est = image.rotate(270)
head_snake_est = join("assets","temp_head_snake_est.gif")  # Chemin du fichier temporaire
image_est.save(head_snake_est)

image_ouest = image.rotate(90)
head_snake_ouest = join("assets","temp_head_snake_ouest.gif")  # Chemin du fichier temporaire
...
# Ouvrir le fichier en mode écriture
with open(join("assets",'score.txt'), "r") as fichier:
...
win.bgcolor("black")
win.bgpic(join("assets","grid.png"))
win.tracer(0)
